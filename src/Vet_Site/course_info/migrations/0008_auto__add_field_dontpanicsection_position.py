...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DontPanicSection.position'
        db.add_column('course_info_dontpanicsection', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DontPanicSection.position'
        db.delete_column('course_info_dontpanicsection', 'position')
