...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollegeContact'
        db.create_table('course_info_collegecontact', (
            ...
            ('tel', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('course_info', ['CollegeContact'])


    def backwards(self, orm):
        # Deleting model 'CollegeContact'
        db.delete_table('course_info_collegecontact')
