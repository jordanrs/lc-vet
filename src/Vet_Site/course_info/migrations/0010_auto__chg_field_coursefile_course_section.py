...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseFile.course_section'
        db.alter_column('course_info_coursefile', 'course_section_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course_info.CourseSection'], null=True))

    def backwards(self, orm):

        # Changing field 'CourseFile.course_section'
        db.alter_column('course_info_coursefile', 'course_section_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['course_info.CourseSection']))
    ...
    models = {
        ...
        'course_info.coursefile': {
            ...
            'course_section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['course_info.CourseSection']", 'null': 'True', 'blank': 'True'}),
