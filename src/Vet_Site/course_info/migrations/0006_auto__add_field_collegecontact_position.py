...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollegeContact.position'
        db.add_column('course_info_collegecontact', 'position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollegeContact.position'
        db.delete_column('course_info_collegecontact', 'position')
